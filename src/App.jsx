...
function App() {
  ...
  useEffect(() => {
    fetch('https://frightened-frog-sweatshirt.cyclic.app/pets_price')
    .then(res => res.json())
    .then(result => {
      console.log(result)
      setPetPrice(result)
    ...
    fetch('https://frightened-frog-sweatshirt.cyclic.app/pets_price_chart')
    .then(res => res.json())
    .then(result => {
      console.log(result)
      setPetChart({
